            ...
            <div class="page-sidebar-wrapper"> 
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" ng-class="{'page-sidebar-menu-closed': settings.layout.pageSidebarClosed}">
                      ...
                      <li class="nav-item  ">
                          <a href="operator#/agendaHarian" class="nav-link nav-toggle">
                              <i class="fa fa-modx"></i>
                              <span class="title">Agenda Harian</span>
                          </a>
                      </li>
                      <li class="start nav-item">
                          <a href="operator#/detailAgenda">
                              <i class="icon-home"></i>
                              <span class="title">Detail Agenda</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/accessPoint" class="nav-link nav-toggle">
                              <i class="fa fa-envelope"></i>
                              <span class="title">Access Point</span>
                          </a>
                    </li>
                      <li class="nav-item  ">
                          <a href="operator#/barangInven" class="nav-link nav-toggle">
                              <i class="fa fa-commenting"></i>
                              <span class="title">Barang Inven</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/invenMasuk" class="nav-link nav-toggle">
                      ...
                      <li class="nav-item  ">
                          <a href="operator#/invenStatus" class="nav-link nav-toggle">
                              <i class="fa fa-random"></i>
                              <span class="title">Inven Status</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/firewall" class="nav-link nav-toggle">
                              <i class="fa fa-calendar"></i>
                              <span class="title">Firewall</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/gangguan" class="nav-link nav-toggle">
                              <i class="fa fa-shopping-basket"></i>
                              <span class="title">Gangguan</span>
                          </a>
                      </li>
                      <li class="nav-item">
                          <a href="operator#/hub" class="nav-link nav-toggle">
                              <i class="fa fa-user"></i>
                              <span class="title">Hub</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/kondisiAlat" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                              <span class="title">Kondisi Alat</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/merekAlat" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                      ...
                      <li class="nav-item  ">
                          <a href="operator#/namaForm" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                              <span class="title">Nama Form</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/penanganan" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                      ...
                      <li class="nav-item  ">
                          <a href="operator#/provider" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                              <span class="title">Provider</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/switchCore" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                              <span class="title">switch_core</span>
                          </a>
                      </li>
                      <li class="nav-item  ">
                          <a href="operator#/switchSub" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                      ...
                      <li class="nav-item  ">
                          <a href="operator#/pddBuffer" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
                      ...
                      <li class="nav-item  ">
                          <a href="operator#/pddError" class="nav-link nav-toggle">
                              <i class="fa fa-file-text-o"></i>
...
<script src="operatorTpl/operator-router.js" type="text/javascript"></script>
